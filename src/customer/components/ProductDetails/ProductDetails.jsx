  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text:lg lg:text-xxl text-gray-900 mt-6">
              ...
              <div className="mt-6">
                <div className="flex item-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">843438 Ratings</p>
        ...
        {/*  ratings and reviews*/}
        <section>
          <h1 className="font-semi-bold text-lg pb-4">
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    precision={0.5}
                  />
                  <p className="opacity-60">483295 Ratings</p>
                </div>
